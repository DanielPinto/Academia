  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_title">
          <h2>Listagem de Atividade Diaria</h2>
          <div class="clearfix"></div>
        </div>
                    ...
                    <div class="modal-content">
                      <form class="" action="{{$urlPlano}}/{{$d->id}}" method="POST" enctype="multipart/form-data">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Editar a Atividade</h4>
                        </div>
                        <div class="modal-body">


                            <div class="form-group">
                              <label for="categoria">Nome da Atividade</label>
      ...
      <div class="modal-content">
        <form class="" action="{{$urlPlano}}" method="POST" enctype="multipart/form-data">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel2">Adcionar uma Atividade</h4>
          </div>
          <div class="modal-body">
