        ...
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{$urlFunc}}/{{$data->id}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <div class="col-md-3 col-sm-3">
              ...
              <span class="label label-info">{{$data->data_admissao}}</span>
              <input type="date" id="data_admissao" required="required" name="data_admissao" class="form-control" value="{{$data->data_admissao}}">
            </div>

            <div class="col-md-6 col-sm-6">
              <label for="funcao">Função <span class="required">*</span></label>
              <span class="label label-info">{{$data->funcao}}</span>
              <select class="select2_single form-control" tabindex="-1" name="funcao" id="funcao">
                <option></option>
                <option value="Administrador" @if($data->funcao=='Administrador')selected="" @endif>Administrador</option>
                <option value="Instrutor" @if($data->funcao=='Instrutor')selected="" @endif>Instrutor</option>
            ...
            <div class="col-md-3 col-sm-3">
              ...
              <span class="label label-info">{{$data->salario}}</span>
              <input type="text" id="salario" required="required" name="salario" class="form-control" value="{{$data->salario}}">
