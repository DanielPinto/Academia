                    ...
                    <div class="modal-content">
                      <form class="" action="{{$urlPlano}}/{{$d->id}}" method="POST" enctype="multipart/form-data">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Editar o Exercicio</h4>
                        </div>
                    ...
                    <div class="modal-content">
                      <form class="" action="{{$urlPlano}}/status/{{$d->id}}" method="POST" enctype="multipart/form-data">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Status do Exercicio</h4>
                        </div>

                        <div class="modal-body">
                            @if ($d->status == 0)
                              Deseja Ativar o Exercicio?
                            @else
                              Deseja Desativar o Exercicio?
                            @endif
